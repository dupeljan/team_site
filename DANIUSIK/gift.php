<?php include 'include/insert_kid.php'; echo "success";?>
...
<form action="ded_moroz.php">
	<h2>
		...
		<script type="text/javascript">
            ...
            var str =  treat() + " " +  <?php echo "\"" . preg_replace('/[^\p{L}\p{N}\s]/u', '', $_POST['name']) . "\""  ;  ?>  + "! " + gratitude() + ". Подарки для тебя:" + <?php include 'include/get_gifts.php';?> + " !!!";
